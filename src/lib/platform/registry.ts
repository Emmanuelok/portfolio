...
export const PLATFORM_AGENTS: readonly PlatformAgentDefinition[] = [
  {
    ...
    phases: ["discover", "investigate", "model", "build", "validate", "launch"],
  },
  {
    id: "discovery",
...
export const PLATFORM_LIFECYCLE: readonly PlatformPhaseDefinition[] = [
  {
    ...
    primaryMode: "idea",
    modes: ["idea", "prompt"],
    route: "/create/workspace?phase=discover&mode=idea",
  ...
  },
  {
    ...
    route: "/create/workspace?phase=investigate&mode=brief",
  ...
  },
  {
    ...
    route: "/create/workspace?phase=model&mode=mindmap",
  ...
  },
  {
    ...
    route: "/create/workspace?phase=build&mode=code",
  ...
  },
  {
    ...
    route: "/create/workspace?phase=validate&mode=brief",
  ...
  },
  {
    ...
    primaryMode: "brief",
    modes: ["brief", "code"],
    route: "/create/workspace?phase=launch&mode=brief",
